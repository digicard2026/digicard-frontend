...
const DarkCard = ({ cardData = {} }) => {
  ...
  const formatBusinessHours = () => {
    const hours = profileData.workingHours;
      ...
      <div className="text-center mt-6 mb-6">
        <div className="relative inline-block">
          ...
          <div className="relative px-6 py-3 bg-white/5 backdrop-blur-sm rounded-lg border border-white/10">
            <p
              className="text-white/90 text-base italic font-medium"
              style={{ fontFamily: "Zona Pro, sans-serif" }}
            >
              "{profileData.tagline}"
            </p>
    ...
    return (
      <div className="text-center mt-6">
        <h3
          ...
          style={{ fontFamily: "Zona, sans-serif" }}
        >
          <FaPhoneAlt className="w-4 h-4 text-green-400 mr-2" />
          Virtual Number
        </h3>
        <button
          onClick={() => handleContact("virtualNumber", profileData.virtualNumber)}
          className="flex items-center justify-center mx-auto bg-green-500/20 hover:bg-green-500/30 text-green-400 px-4 py-2 rounded-lg border border-green-500/30 transform transition-transform duration-300 hover:scale-105"
        >
          <FaPhoneAlt className="w-4 h-4 mr-2" />
          <span style={{ fontFamily: "Zona Pro, sans-serif" }}>
    ...
    return (
      <div className="text-center mt-6">
        <h3
          ...
          style={{ fontFamily: "Zona, sans-serif" }}
        >
          <FaRegClock className="w-4 h-4 text-blue-400 mr-2" />
          Business Hours
        </h3>
        <div className="space-y-1 max-w-md mx-auto">
          {hours.map((hour, index) => (
            <div
              key={index}
              className="flex justify-between px-3 py-1 text-sm text-white/80"
              style={{ fontFamily: "Zona Pro, sans-serif" }}
            >
  ...
  const renderCatalogPDF = () => {
    if (!profileData.catalogPDF) return null;
    ...
    return (
      <div className="text-center mt-6">
        ...
        <button
          onClick={() => window.open(profileData.catalogPDF, '_blank')}
  ...
  // Product Video Section (Separate from profile video)
  const renderProductVideo = () => {
    ...
    return (
      <div className="text-center mt-6">
        ...
        <div className="relative rounded-lg overflow-hidden h-40 bg-white/5 flex items-center justify-center mx-auto max-w-md">
          <video
          ...
          />
          {profileData.productVideo.title && (
            <div className="absolute bottom-0 left-0 right-0 bg-black/60 p-2">
              <p
                className="text-white/90 text-sm leading-relaxed"
                style={{ fontFamily: "Zona Pro, sans-serif" }}
  ...
  // Videos Slider Section (for multiple videos)
  const renderVideosSlider = () => {
    if (profileData.videos.length === 0) return null;
    ...
    return (
      <div className="text-center mt-6">
        ...
        <div className="relative overflow-hidden max-w-xl mx-auto">
          <div className="flex flex-col space-y-3">
            {getCurrentVideoItem() && (
              <div className="relative rounded-lg overflow-hidden h-48 bg-white/5 flex items-center justify-center">
                <video
  ...
  const renderEmails = () => {
    if (profileData.emails.length === 0) return null;
        ...
        <div className="space-y-2 max-w-md mx-auto">
          {profileData.emails.map((email, index) => (
            ...
            >
              ...
              <span
                className="text-white/70 text-sm truncate ml-2"
                style={{ fontFamily: "Zona Pro, sans-serif" }}
              >
                {email.address}
              </span>
  ...
  // NFC Card Section (different from NFC Settings)
  const renderNFCCard = () => {
    ...
    <div className="min-h-screen w-full flex justify-center items-center py-6 overflow-y-auto 
      ...
      <div className="w-[450px] rounded-3xl overflow-hidden relative z-10">
        ...
        <div className="pt-4 pb-6 px-5 space-y-3">
          ...
          {/* Brand Label - Neon / Highlight Style */}
          {profileData.brandLabel && (
            <div className="text-center mt-19 mb-2">
              {/* Brand Label Heading */}
              <h3
                className="text-base font-semibold text-white flex justify-center items-center mb-1"
                style={{ fontFamily: "Zona, sans-serif" }}
                      ...
                      onClick={() => {
                        switch (element.type) {
                          ...
                          case 'newsletter-signup':
                            // These would typically open modals or external links
                          ...
                          case 'appointment-scheduler':
                            // Open calendar or booking system
                          ...
                          case 'language-switcher':
                            // Toggle language (would need implementation)
                            break;
                          case 'chat-assistant':
                            // Open chat widget
                            break;
