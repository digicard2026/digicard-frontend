            ...
            <div className="w-full max-w-xs mx-auto">
              ...
              <form onSubmit={formik.handleSubmit} className="space-y-6">
                ...
                {showResend && (
                  <div className="mt-2 text-center">
                    ...
                    <button
                      ...
                      disabled={isLoading}
                      className="w-full py-2 text-sm font-semibold text-white bg-orange-500 rounded-lg hover:bg-orange-600 transition-all"
                    >
                ...
                <div className="space-y-2">
                  <div className="flex justify-between">
                    ...
                    <Link to="/forgot" className="text-xs text-blue-600">
                      Forgot Password?
                    </Link>
                  </div>
                  <div className="relative">
                    <input
                      type={showPassword ? "text" : "password"}
                      name="password"
                      className="w-full px-4 py-3 text-sm border rounded-lg pr-10"
                      onChange={formik.handleChange}
                      onBlur={formik.handleBlur}
                      value={formik.values.password}
                      disabled={isLoading}
              ...
              <div className="text-center pt-6">
                <p className="text-sm">
                  ...
                  <Link to="/signup/partner" className="text-blue-600 font-semibold">
                    Sign Up
                  </Link>
                </p>
              </div>
