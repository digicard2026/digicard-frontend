...
function AddVbList() {
    ...
    const sendDataToBackend = async (data) => {
        try {
            ...
            const response = await fetch(`${API_URL}/api/v1/vb-list/create`, {
                method: 'POST',
            ...
            console.log('Error creating list 53:', error);
            showToast('Failed to create the list. Please try again.', 'error');
        }
    };
    ...
    return (
        <>
            ...
            <Breadcrumb pageName="Add New List" />
